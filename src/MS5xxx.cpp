...
void MS5xxx::start_mesure(byte D1_OSR)
{
  send_cmd(D1_OSR);
  return;
}
...
void MS5xxx::set_wire()
{
  _Wire = &Wire;
  //_Wire->begin();
}

void MS5xxx::set_wire1()
{
  _Wire = &Wire1;
}

void MS5xxx::begin_wire()
{
  _Wire->begin();
  _Wire->setClock(400000L);
}

void MS5xxx::begin_wire1()
{
  _Wire->begin(23, 19,400000L);
}